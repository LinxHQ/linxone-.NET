...
namespace linxOne.BackendApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<linxOneDbContext>(options =>
            options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.MainConnectionString)));

            services.AddIdentity<AUser, ARoles>()
                .AddEntityFrameworkStores<linxOneDbContext>()
                .AddDefaultTokenProviders();

            //declare DI
            services.AddTransient<ICustomerService, ManagerCustomerService>();
            services.AddTransient<UserManager<AUser>, UserManager<AUser>>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger LinxOne", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Swagger LinxOne V1");
            });
